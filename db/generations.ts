...
// Count how many generations a user has made since a specific date (UTC)
...
// List all generations for a user, ordered by creation time (newest first)
...
// Helper type for inserting a new generation (without auto-generated fields)
type InsertGenerationInput = Omit<
  InferInsertModel<typeof generations>,
  "id" | "createdAt"
>;

// Insert a new generation record (typically called after a successful API call)
